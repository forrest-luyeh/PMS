"""create_tenant_brand_hotel_tables_fix

Revision ID: 4db4f2bbca2a
Revises: c117eac7c80f
Create Date: 2026-03-25 15:32:45.159871
...
revision: str = '4db4f2bbca2a'
down_revision: Union[str, Sequence[str], None] = 'c117eac7c80f'
...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_hotels_brand_id'), 'hotels', ['brand_id'], unique=False)
...
def downgrade() -> None:
    ...
    op.drop_index(op.f('ix_hotels_brand_id'), table_name='hotels')
